...
namespace ExpSystem
{
    public partial class FormVariables : Form
    {
        ...
        public FormVariables(ExpertSystem es)
        {
            InitializeComponent();
            this.es = es;
        ...
        {
            FormAddVariable f = new FormAddVariable(this, AllowQueried);
        ...
        {
            FormDomains f = new FormDomains(es);
        ...
        private void btnEditVar_Click(object sender, EventArgs e)
        {
            ...
            FormAddVariable f = new FormAddVariable(this, true, vars[listBox1.SelectedItem.ToString()]);
