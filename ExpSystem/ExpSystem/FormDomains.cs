...
namespace ExpSystem
{
    public partial class FormDomains : Form
    {
        ...
        public FormDomains(ExpertSystem es)
        {
            InitializeComponent();
        ...
        {
            FormAddDomain f = new FormAddDomain(this);
        ...
        public DialogResult AddValue(ValueDomain d)
        {
            try
            {
                FormAddValue f = new FormAddValue(this);
                DialogResult dr = f.ShowDialog();
                if (dr == DialogResult.OK)
                {
                    if (newVal == "")
        ...
        private void btnEditDomain_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormAddDomain f = new FormAddDomain(this, oldDom);
        ...
        private void btnEditValue_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormAddValue f = new FormAddValue(this, oldVal);
