...
namespace ExpSystem
{
    public partial class FormAddVariable : Form
    {
        ...
        public FormAddVariable(FormVariables f, bool AllowQuaried)
        {
            InitializeComponent();
            this.f = f;
        ...
        public FormAddVariable(FormVariables f, bool AllowQuaried, Variable v)
            : this(f, AllowQuaried)
        {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    f.type = VarType.Deducted;
                    break;
                case 1:
                    f.type = VarType.Queried;
                    break;
                case 2:
                    f.type = VarType.DeductionQueried;
                    break;
            }
            f.newDom = comboBox2.Text;
           // f.newReasoning = textBox2.Text;
            f.newQuestion = txtQuestion.Text;
        }
